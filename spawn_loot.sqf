...
switch (_iItem) do {
  	...
  	case "SVD_CAMO": { _holderItem = "M24"};
        case "M107_DZ": { _holderItem = "DMR"};
	case "AKS_74_U": { _holderItem = "huntingrifle"};
	case "DMR": { _holderItem = "M40A3"};
	case "M1014": { _holderItem= "Saiga12K"};
	case "Mk_48_DZ": { _holderItem= "M16A4_ACG"};
	case "Crossbow": { _holderItem= "Sa61_EP1"};
	case "M4A1_AIM_SD_camo": { _holderItem = "G36_C_SD_eotech"};
	case "FN_FAL_ANPVS4": { _holderItem = "M4A3_CCO_EP1"};
	case "MP5SD": { _holderItem = "AKS_74_UN_kobra"};
	case "M4A1_Aim": { _holderItem= "AK_107_kobra"};
        case "M4A3_CCO_EP1": { _holderItem = "RPK_74"};
        case "M16A4_ACG": { _holderItem = "AKS_74_PSO"};
        case "M16A2": { _holderItem = "G36C"};
        case "M24": { _holderItem = "SVD"};
        case "M4A1_HWS_GL": { _holderItem = "BAF_L85A2_RIS_Holo"};
        case "M4A1": { _holderItem = "AK_74"};
        case "M16A2GL": { _holderItem = "bizon_silenced"};
        case "bizon_silenced": { _holderItem = "M16A2GL"};
        case "M40A3": { _holderItem = "SVD_CAMO"};
